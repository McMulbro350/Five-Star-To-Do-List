...
- **Real-time sync** — make a change on one device, see it appear on another
...
- If you ever see "Synced ✓" turn into an error message in the sidebar, it usually means either your internet connection dropped or the Firestore rules weren't published — check the browser console for details.
